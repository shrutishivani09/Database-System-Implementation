...
char *tpch_dir ="/cise/homes/sshivani/git/tpch-dbgen"; // dir where dbgen tpch files (extension *.tbl) can be found
char *dbfile_dir ="/cise/homes/sshivani/Database-System-Implementation/ProjectPhase1/P1"; 
